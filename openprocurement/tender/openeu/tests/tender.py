...
class TenderResourceTest(BaseTenderWebTest):
    ...
    def test_create_tender(self):
        ...
        self.assertEqual(set(tender) - set(test_tender_data), set(
            [u'id', u'dateModified', u'enquiryPeriod', u'auctionPeriod', u'complaintPeriod', u'tenderID', u'status', u'procurementMethod', u'awardCriteria', u'submissionMethod', u'next_check', u'owner']))
